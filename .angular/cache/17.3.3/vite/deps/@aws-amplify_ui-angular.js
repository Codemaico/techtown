...
function camelCaseTransform(input2, index) {
  ...
  return pascalCaseTransform(input2, index);
}
...
function sentenceCaseTransform(input2, index) {
...
// node_modules/@aws-amplify/ui-angular/node_modules/nanoid/index.dev.js
if (true) {
...
function VerifyUserComponent_div_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵproperty("value", unverifiedUserAttribute_r1.key)("id", ctx_r1.labelId);
    ɵɵadvance();
    ɵɵproperty("for", ctx_r1.labelId);
    ɵɵadvance();
    ɵɵtextInterpolate(ctx_r1.getLabel(unverifiedUserAttribute_r1.key, unverifiedUserAttribute_r1.value));
  }
}
...
function AuthenticatorComponent_div_0_amplify_tabs_4_amplify_slot_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "amplify-slot", 21);
...
function AuthenticatorComponent_div_0_amplify_tabs_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "amplify-tabs", 17);
    ...
    ɵɵelementStart(1, "amplify-tab-item", 18);
    ɵɵtemplate(2, AuthenticatorComponent_div_0_amplify_tabs_4_amplify_slot_2_Template, 2, 1, "amplify-slot", 7);
    ɵɵelementEnd();
    ɵɵelementStart(3, "amplify-tab-item", 18);
    ɵɵtemplate(4, AuthenticatorComponent_div_0_amplify_tabs_4_amplify_slot_4_Template, 2, 1, "amplify-slot", 19);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext(2);
...
VerifyUserComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function VerifyUserComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtext(4);
      ɵɵelementEnd()();
      ɵɵtemplate(5, VerifyUserComponent_div_5_Template, 4, 4, "div", 4);
      ɵɵpipe(6, "keyvalue");
      ɵɵelementStart(7, "button", 5);
      ɵɵtext(8);
      ɵɵelementEnd();
...
AuthenticatorComponent.ɵcmp = ɵɵdefineComponent({
  ...
  dependencies: [NgIf, AmplifySlotComponent, ConfirmResetPasswordComponent, ConfirmSignInComponent, ConfirmSignUpComponent, ConfirmVerifyUserComponent, ForceNewPasswordComponent, ForgotPasswordComponent, SetupTotpComponent, SignInComponent, SignUpComponent, TabItemComponent, TabsComponent, VerifyUserComponent],
  encapsulation: 2
});
(() => {
